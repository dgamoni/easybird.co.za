				...
				global $woocommerce, $post;
					    ...
					    foreach ($available_variations as $key => $variation) 
						    { 
						        ...
						        if($stock):
						        	echo "<span class='available_stock' data-id='".sanitize_title($variation['attributes'][$t])."' style='display:none'>".$stock_val."</span>";
						    	endif;
						    }
							...
							if ( ! empty( $options ) ) {
								if ( taxonomy_exists( $name ) ) {
									...
									foreach ( $options as $option ) {
										...
										echo "<span class='stockk ".sanitize_title($option)."' id='stockk' ></span><br>";
